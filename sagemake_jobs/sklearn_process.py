...
sklearn_processor.run(
    ...
    outputs=[
        ProcessingOutput(source="/opt/ml/processing/train", destination=f"{output_data}/train"),
        ProcessingOutput(source="/opt/ml/processing/test", destination=f"{output_data}/test"),
    ],
